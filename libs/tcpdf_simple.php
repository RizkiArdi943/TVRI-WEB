<?php
/**
 * TCPDF Simple - Library sederhana untuk generate PDF dengan TCPDF
...
class TCPDFSimple {
    ...
    public function output() {
        // Generate PDF menggunakan pendekatan yang lebih sederhana
    ...
    private function generateSimplePDF() {
        // Generate PDF dengan format yang lebih sederhana tapi reliable
        $pdf_content = "%PDF-1.4\n";
        ...
        if (!empty($this->data)) {
            ...
            foreach ($this->data as $rowIndex => $row) {
                ...
                foreach ($row as $index => $cell) {
                    ...
                    $max_length = 20; // Maksimal karakter per kolom
